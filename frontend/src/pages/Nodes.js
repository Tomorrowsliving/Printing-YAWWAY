            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-900/50 p-3 rounded-lg flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold">{node.cpu_usage}%</p>
                </div>
              </div>
              <div className="bg-slate-900/50 p-3 rounded-lg flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold">{node.ram_usage}%</p>
                </div>
              </div>
              <div className="bg-slate-900/50 p-3 rounded-lg flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold">{node.temperature}°C</p>
                </div>
              </div>
              <div className="bg-slate-900/50 p-3 rounded-lg flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold truncate max-w-[80px]">{node.uptime}</p>
                </div>
              </div>
            </div>
